...
cout<<" Total no. of 1st class seats:-"<<c1<<"\n"<<"Fare for each first class seat:-"<<c1fare<<"\n"<<"Total no. of 2nd class seats:-"<<c2<<"\n"<<"Fare for each second class seat:-"<<c2fare<<"\n";
cout<<"Date of Travel:-"<<"(day-month-year format)"<<"-->>"<<d<<"-"<<m<<"-"<<y<<"\n"<<endl;
}
};
class reser
{
...
cout<<"nTrain no:";cin>>tno;
cout<<"nTrain name:";gets(tname);
cout<<"nBoarding point:";gets(bp);
cout<<"nDestination pt:";gets(dest);
cout<<"nNo of seats required:";cin>>nosr;
for(i=0;i<nosr ;i++)
{
cout<<"nPassenger name:";gets(pname[i]);
cout<<"nPassenger age:";cin>>age[i];
}
...
cout<<"       (|||) !!!!!!       -----------                                       ))         \n";
cout<<"     (     ))))-------                         -|  ENTER              |-     ))        \n";
cout<<"    (       ))))        -X-TRAIN RIDE-        | |  HERE------------   | |     ))       \n";
cout<<"   (    X    ))))       ~~~~~~~~~~~~~~        | |  KEEP one FEET      | |     ))       \n";
cout<<"    (       ))))                               -|  DISTANCE FROM TRACK|-     ))        \n";
cout<<"     (     ))))      +@+                                                    ))          \n";
cout<<"      (   ))))   + @@@@@@ +  ++++++++++@+++++++++++                                    \n";
cout<<"      //////    + @@@@@@@@ +                                                           \n";
cout<<"  /////////      + @@@@@@ +  \\\\\\\\\\\  \\\\\\\  \\\\\\\\\\\  \\\\\\\\\\\     ]--]]\n";
